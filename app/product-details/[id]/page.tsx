...
//   title: "Product Details Page | Free Next.js Template for Startup and SaaS",
//   description: "This is Product Details Page for Startup Nextjs Template",
//   // other metadata
// };
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          By <span>{product.author.name}</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  <p className="mb-10 font-medium text-justify leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    {
                      product.paragraph
                    }
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[85/44]">
                      <Image
                        src={product.image}
                        alt="image"
                        fill
                  ...
                  <p className="mb-8 font-medium text-justify leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    {
                      product.details
                    }
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    ...
                    🔥 Embark on a transformative journey with IELC – from taking your first steps in English to mastering eloquent expression, our courses are tailored to turn every learner into a language enthusiast and every conversation into an opportunity for growth and discovery. 🔥
                    </p>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      {/*  <TagButton text="IELC Courses" />*/}
                      {/*  <TagButton text="IECL Grammer" />*/}
                      {/*  <TagButton text="IELC Parachinar" />*/}
                      {/*  <TagButton text="IELC PCR" />*/}
                      {/*  <TagButton text="IELC-PCR" />*/}
                      {/*  <TagButton text="IELC-Parachinar" />*/}
                      {/*  <TagButton text="ielc" />*/}
                      {/*</div>*/}
