  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Receive exclusive updates, announcements, and engage in discussions with fellow members. Click the 'Join Our WhatsApp Group' button to become part of our vibrant community today!
      </p>
      <div>
        <button
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-lg bg-green px-9 py-4 text-base font-medium text-white duration-300 hover:bg-green/90">
          <a href="https://whatsapp.com/channel/0029VaE0N1T59PwIfj0HhI2l" target="_blank" rel="noreferrer">Join Whatsapp Channel</a> 
        </button>
        <button
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-lg bg-green px-9 py-4 text-base font-medium text-white duration-300 hover:bg-green/90">
          <a href="https://chat.whatsapp.com/Gj7kVcbOoBq3A2HZl4npEy" target="_blank" rel="noreferrer">Join Whatsapp Group</a> 
        </button>
        <p className="dark:text-body-color-dark text-center text-base leading-relaxed text-body-color">
        Please note that any violation of group rules may result in removal. Respect and adhere to the guidelines for a positive and inclusive community experience.
        </p>
      </div>
