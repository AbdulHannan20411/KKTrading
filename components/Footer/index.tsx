      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full justify-center flex text-center md:text-start md:block md:justify-normal px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16 ">
                ...
                <div className="flex items-center justify-center md:justify-normal">
                  <a
                    href="https://www.facebook.com/profile.php?id=100082967007572"
                  ...
                  <a
                    href="https://www.youtube.com/@IELC-Parachinar"
                    target="_blank" rel="noreferrer"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                  ...
                  <a
                    href="https://www.instagram.com/sajidhussain1196"
                    target="_blank" rel="noreferrer"
                    aria-label="social-link"
            ...
            <div className="w-full text-center sm:text-start px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            ...
            <div className="w-full text-center sm:text-start px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                  Support & Help
                </h2>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              CopyRight © 2024 KK Trading Company. All Rights Reserved
            </p>
          </div>
        </div>
